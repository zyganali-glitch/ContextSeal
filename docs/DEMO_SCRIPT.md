...
### 01:00-01:15 - Agent trace and AI boundary
...
### 01:15-01:35 - Inspectable safe package

- On screen: Select the model, parity test, rollback, and owner brief in the artifact viewer; show the rename diff and manifest grounding link.
- Spoken beat: `Instead of a destructive rename, ContextSeal generates and exposes an explicit staged package: dbt model, parity test, rollback, owner brief, and review bundle.`
- Subtitle: `The generated package is inspectable, grounded, and ready for review.`
...
### 01:50-02:08 - Passport and inheritance
