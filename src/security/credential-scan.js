...
/**
 * Detect high-confidence credential material in user-controlled text before it
 * can enter a run, passport, artifact, UI response, or export. Only signature
 * labels are returned; matched values are deliberately never exposed.
 */
